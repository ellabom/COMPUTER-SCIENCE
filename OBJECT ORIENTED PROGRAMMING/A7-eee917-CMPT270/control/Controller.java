...
public class Controller implements KeyListener, ActionListener, GameObserver {
    ...
    private invaderView invaderview;
    ...
    public void start() {
        ...
        invaderview = new invaderView(600, 550);
        view.showWelcomeView(this);
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionCommand.equals("newgame")) {
            ...
            invaderview.showInvaderView(gameInfo);
