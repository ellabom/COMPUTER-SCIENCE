...
public class ArrayedBinaryTreeWithCursors280<I> extends
	...
	public void insert(I x) throws ContainerFull280Exception, DuplicateItems280Exception {
		...
		if(this.isFull()){
			throw new ContainerFull280Exception("Cannot insert into a full tree");
		}
		else{
	...
	public void deleteItem() throws NoCurrentItem280Exception {
		...
		if(this.isEmpty()){
			throw new NoCurrentItem280Exception("Item could not be deleted because tree is empty");
		}
	...
	public void delete(I x) throws ItemNotFound280Exception {
		...
		if(this.isEmpty()){
			throw new ItemNotFound280Exception("This item does not exist, tree is empty");
		}
		if(!this.has(x)){
			throw new ItemNotFound280Exception("This item does not exist!");
		}

		CursorPosition280 savePosition = this.currentPosition();
		this.goFirst();
	...
	public boolean has(I y) {
		...
		try{
			//if y can be obtained from the tree
			this.obtain(y);
		}catch(ItemNotFound280Exception exception){
			return false;
		}

		return true; // this line is a placeholder to prevent a compiler error.  Remove as needed.
	}
	...
	public boolean before() {
		...
		// this line is a placeholder to prevent a compiler error.  Remove as needed.
	}

	@Override
	public boolean after() {
		// TODO - Implement this method
		return this.currentNode > this.count || this.isEmpty(); // this line is a placeholder to prevent a compiler error.  Remove as needed.
	}
	...
	public void goForth() throws AfterTheEnd280Exception {
		// TODO - Implement this method
		if(this.after()){
			throw new AfterTheEnd280Exception("Cannot move because the cursor is at the after position");
		}
	...
	public void goFirst() throws ContainerEmpty280Exception {
		...
		if(this.isEmpty()){
			throw new ContainerEmpty280Exception("Cannot move to the first item of an empty tree");
		}
		this.currentNode = 1;
	}
	...
	public void parent() throws InvalidState280Exception {
        // TODO - Implement this method
		if(currentNode <= 1){
			throw new InvalidState280Exception("Cannot move to the parent of the root.");
		}
		else{
	...
	public void goLeftChild()  throws InvalidState280Exception, ContainerEmpty280Exception {
        // TODO - Implement this method
		if(isEmpty()){
			throw new ContainerEmpty280Exception("Cannot position cursor in an empty tree.");
		}
		int lChild = findLeftChild(currentNode);
		if( lChild > count){
	...
	public void goSibling() throws InvalidState280Exception, ContainerEmpty280Exception {
        // TODO - Implement this method
		if(this.isEmpty()){
			throw new ContainerEmpty280Exception("Can't move in an empty tree");
		}
		if(currentNode > count || currentNode <= 1){
			throw new InvalidState280Exception("Current node has no sibling");
		}
		int parentNode = findParent(currentNode);
		if(currentNode == findLeftChild(parentNode)){
			currentNode = findRightChild(parentNode);
		}else if(currentNode == findRightChild(parentNode)){
			currentNode = findLeftChild(parentNode);
		}
	...
	public void root() throws ContainerEmpty280Exception {
        // TODO - Implement this method
		if(this.isEmpty()){
			throw new ContainerEmpty280Exception("Cannot move cursor because empty tree has no root.");
		}
		else{
			currentNode = 1;
		}
