# CMPT 317 A Python implementation of Game Tree Search 
# - Minimax with Alpha-Beta Pruning
#     also collects data
#     also uses a depth limit
#     also uses transposition table
...
#     Minimax search with Alpha-Beta Pruning, a transpotiion table, depth limit and detailed data collection
#
...
#    searcher = Minimax(game)         # create an instance of Minimax for the game
